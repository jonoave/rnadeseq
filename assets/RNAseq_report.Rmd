...
The differential expression analysis was performed by the use of a fork of the `rnadeseq` pipeline [^5] which was done to adapt the workflow reporting of smrnaseq results.
